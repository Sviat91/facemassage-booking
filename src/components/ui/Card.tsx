...
>(({ title, children, className }, ref) => {
  const base = 'rounded-2xl bg-white/70 backdrop-blur border border-border shadow-sm p-4 overflow-visible dark:bg-dark-card/80 dark:border-dark-border dark:text-dark-text'
  return (
